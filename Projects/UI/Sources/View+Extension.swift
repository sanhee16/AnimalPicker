...
public extension View {
    ...
    func paddingLeading(_ value: CGFloat) -> some View {
        return self.padding(EdgeInsets(top: 0, leading: value, bottom: 0, trailing: 0))
    }
    func paddingTrailing(_ value: CGFloat) -> some View {
    ...
    func frame(both: CGFloat, aligment: Alignment = .center) -> some View {
        return self
